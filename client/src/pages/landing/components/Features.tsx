...
const featuresList = [
  {
    ...
    desc: `EduHelper is designed to empower you to learn about anything you want, whenever you want. 
        Our platform adapts to your pace, making education flexible and accessible.`,
    icon: (
      <svg
  ...
  {
    id: 2,
    title: "Accessible Education for Everyone",
    desc: `We're committed to breaking down barriers to education. With EduHelper, regardless of your background, 
        you have the opportunity to access comprehensive learning resources.`,
    icon: (
      <svg
        style={{ width: "2rem", height: "2rem" }}
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    desc: `Harness the power of AI to create effective flashcards easily, helping you memorize information faster 
        and more efficiently. EduHelper's AI tools are here to support your learning journey.`,
    icon: (
      <svg
        style={{ width: "2rem", height: "2rem" }}
        viewBox="0 0 24 24"

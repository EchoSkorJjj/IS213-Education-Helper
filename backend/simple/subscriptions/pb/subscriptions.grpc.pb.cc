...
::grpc::Status Subscription::Stub::GetSubscription(::grpc::ClientContext* context, const ::subscription_pb::GetSubscriptionRequest& request, ::subscription_pb::GetSubscriptionResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::subscription_pb::GetSubscriptionRequest, ::subscription_pb::GetSubscriptionResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetSubscription_, context, request, response);
}

void Subscription::Stub::async::GetSubscription(::grpc::ClientContext* context, const ::subscription_pb::GetSubscriptionRequest* request, ::subscription_pb::GetSubscriptionResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::subscription_pb::GetSubscriptionRequest, ::subscription_pb::GetSubscriptionResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetSubscription_, context, request, response, std::move(f));
}

void Subscription::Stub::async::GetSubscription(::grpc::ClientContext* context, const ::subscription_pb::GetSubscriptionRequest* request, ::subscription_pb::GetSubscriptionResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::subscription_pb::GetSubscriptionResponse>* Subscription::Stub::PrepareAsyncGetSubscriptionRaw(::grpc::ClientContext* context, const ::subscription_pb::GetSubscriptionRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::subscription_pb::GetSubscriptionResponse, ::subscription_pb::GetSubscriptionRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetSubscription_, context, request);
}
...
::grpc::Status Subscription::Stub::DeleteSubscription(::grpc::ClientContext* context, const ::subscription_pb::DeleteSubscriptionRequest& request, ::subscription_pb::DeleteSubscriptionResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::subscription_pb::DeleteSubscriptionRequest, ::subscription_pb::DeleteSubscriptionResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_DeleteSubscription_, context, request, response);
}

void Subscription::Stub::async::DeleteSubscription(::grpc::ClientContext* context, const ::subscription_pb::DeleteSubscriptionRequest* request, ::subscription_pb::DeleteSubscriptionResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::subscription_pb::DeleteSubscriptionRequest, ::subscription_pb::DeleteSubscriptionResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_DeleteSubscription_, context, request, response, std::move(f));
}

void Subscription::Stub::async::DeleteSubscription(::grpc::ClientContext* context, const ::subscription_pb::DeleteSubscriptionRequest* request, ::subscription_pb::DeleteSubscriptionResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::subscription_pb::DeleteSubscriptionResponse>* Subscription::Stub::PrepareAsyncDeleteSubscriptionRaw(::grpc::ClientContext* context, const ::subscription_pb::DeleteSubscriptionRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::subscription_pb::DeleteSubscriptionResponse, ::subscription_pb::DeleteSubscriptionRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_DeleteSubscription_, context, request);
}

::grpc::ClientAsyncResponseReader< ::subscription_pb::DeleteSubscriptionResponse>* Subscription::Stub::AsyncDeleteSubscriptionRaw(::grpc::ClientContext* context, const ::subscription_pb::DeleteSubscriptionRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
Subscription::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Subscription::Service, ::subscription_pb::GetSubscriptionRequest, ::subscription_pb::GetSubscriptionResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Subscription::Service* service,
             ::grpc::ServerContext* ctx,
             const ::subscription_pb::GetSubscriptionRequest* req,
             ::subscription_pb::GetSubscriptionResponse* resp) {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< Subscription::Service, ::subscription_pb::DeleteSubscriptionRequest, ::subscription_pb::DeleteSubscriptionResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Subscription::Service* service,
             ...
             ::subscription_pb::DeleteSubscriptionResponse* resp) {
...
::grpc::Status Subscription::Service::DeleteSubscription(::grpc::ServerContext* context, const ::subscription_pb::DeleteSubscriptionRequest* request, ::subscription_pb::DeleteSubscriptionResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");

...
const featuresList = [
  ...
  },
  {
    ...
    desc: `Harness the power of AI to create effective flashcards easily, helping you memorize information faster. EduHelper's AI tools are here to support your learning journey.`,
    icon: (
      <svg
        style={{ width: "2rem", height: "2rem" }}
        viewBox="0 0 24 24"
